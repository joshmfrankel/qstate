...
describe ProposalsController do
  ...
  let(:valid_attributes) { { "lead_presenter" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved proposal as @proposal" do
        ...
        post :create, {:proposal => { "lead_presenter" => "invalid value" }}, valid_session
        assigns(:proposal).should be_a_new(Proposal)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested proposal" do
        ...
        Proposal.any_instance.should_receive(:update).with({ "lead_presenter" => "MyString" })
        put :update, {:id => proposal.to_param, :proposal => { "lead_presenter" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the proposal as @proposal" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Proposal.any_instance.stub(:save).and_return(false)
        put :update, {:id => proposal.to_param, :proposal => { "lead_presenter" => "invalid value" }}, valid_session
        assigns(:proposal).should eq(proposal)
      end
